...
def start_scheduler(logdir, addr, port, ssh_username, ssh_port, ssh_private_key, remote_python=None, dashboard_port=8787):
    cmd = '{python} -m distributed.cli.dask_scheduler --port {port} --bokeh-port {dashboard_port}'.format(
        python=remote_python or sys.executable, port=port, logdir=logdir, dashboard_port=dashboard_port)
...
class SSHCluster(object):
    ...
    def __init__(self, scheduler_addr, scheduler_port, worker_addrs, nthreads=0, nprocs=1,
                 ...
                 memory_limit=None, worker_port=None, nanny_port=None, dashboard_port=8787):
        ...
        self.scheduler = start_scheduler(logdir, scheduler_addr,
                                         ...
                                         ssh_private_key, remote_python, dashboard_port)
